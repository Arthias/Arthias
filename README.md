...
- 🔭 Building **[Artemis Quiver](https://github.com/Arthias/Artemis_Quiver)** — an AI-powered job-search Chrome extension + SPA (multi-provider LLM support, local-first data, versioned releases)
